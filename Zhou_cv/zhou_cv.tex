...
\photo[64pt][0.05pt]{zhou_cv.jpg}                  % ‘64pt’是图片必须压缩至的高度、‘0.4pt‘是图片边框的宽度 (如不需要可调节至0pt)、’picture‘ 是图片文件的名字;可选项、如不需要可删除本行
...
\cvdoubleitem{最高学历：}{博士研究生}{研究方向：}{反问题算法、地震波成像}
...
\section{Publication}
\cvitem{论文名称：}{A Direct Imaging Method for Half-Space Inverse Elastic Scattering Problems, with Z. Chen, submitted, 2018.}
\cvitem{}{A Direct Imaging Method for Elastic Scattering Data without Phaseless Data, with Z. Chen, preprint, 2018.}
\cvitem{}{Absense of Positive Eigenvalues for the Linearized Elasticity System in the Half Space. with Z.Chen, preprint, 2018.}
\section{获奖情况}
