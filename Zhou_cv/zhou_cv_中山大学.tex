...
\cvdoubleitem{最高学历：}{博士研究生}{研究方向：}{散射问题，反问题}
...
\section{Publication}
\cvitem{论文名称：}{A Direct Imaging Method for Half-Space Inverse Elastic Scattering Problems, with Z. Chen, Inverse Problem，Accepted, 2019.}
\cvitem{}{A Direct Imaging Method for Elastic Scattering Data without Phaseless Data, with Z. Chen, preprint, 2019.}
\cvitem{}{Absense of Positive Eigenvalues for the Linearized Elasticity System in the Half Space.  preprint, 2019.}
\section{获奖情况}
